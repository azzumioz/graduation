...
public class VoteTestData {
    public static final int VOTE1 = START_SEQ + 20;
    public static final int VOTE2 = START_SEQ + 21;
    public static final int VOTE3 = START_SEQ + 22;
    public static final int VOTE4 = START_SEQ + 23;
    public static final int VOTE5 = START_SEQ + 24;
    public static final int VOTE6 = START_SEQ + 25;
...
//        return new VoteTo (of(2019, Month.DECEMBER, 20, 10, 0), 100002);
//    }
    ...
    public static ResultMatcher contentJson(Iterable<VoteTo> expected) {
